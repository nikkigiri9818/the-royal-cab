...
const TaxiContactSection = () => {
   return (
      <section className="taxi-contact-section">
            ...
            <div className="row align-items-center">
               ...
               <div className="col-lg-6">
                  <div className="taxi-contact-info">
                     ...
                     <p className="contact-description">
                        Looking for a comfortable taxi in Jaipur or planning
                        a trip across Rajasthan? Get in touch with The Royal
                        Cars for airport transfers, local rides, one-way
                        taxis, luxury cars and Rajasthan tour packages.
                     </p>
               ...
               <div className="col-lg-6">
                  <div className="taxi-contact-form">
                     ...
                     <div className="form-heading">
                        ...
                        <p>
                           Tell us about your travel plan and our team
                           will help you with the right taxi or tour service.
                        </p>
                     ...
                     <form>
                        ...
                        <div className="form-group">
                           ...
                           <textarea
                              rows={4}
                              placeholder="Tell us about your travel plan, pickup location, destination and travel date..."
                           />
         ...
         {/* AAPKA PURANA CSS YAHAN SAME RAHEGA */}
         <style jsx>{`
